...
void encoder::write_int (unsigned long long value) { write_type_value (0, value); }
...
void encoder::write_float (float f)
{
        int major_type = 7 << 5;
        _out->put_byte ((unsigned char)(major_type | 26));
...
void encoder::write_special (int special) { write_type_value (7, (unsigned int)special); }
